<template>
  <div>
    ...
    >
      ...
      <h1 class="project-name">Liannian9</h1>
      <h2 class="project-tagline">欢迎来到liannian9的个人博客。</h2>
      <a href="https://github.com/liannian9" target="_blank" class="btn">GitHub主页</a>
      <a href="https://gitee.com/liannian9/fed-e-task-03-04/tree/master/code/my-gridsome-homework" target="_blank" class="btn">博客源码</a>
    </section>
