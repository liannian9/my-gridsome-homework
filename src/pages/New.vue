    ...
    <div style="min-height: 600px;" class>
      <div class="el-card is-never-shadow" style="min-height: 400px;">
        ...
        <div class="el-card__body">
          ...
          <div
            style="font-size: 1.1rem; line-height: 1.5; color: rgb(48, 49, 51); border-bottom: 1px solid rgb(228, 231, 237); padding: 5px 0px;"
          >
            <pre style="font-family: 微软雅黑;" v-html="mdToHtml($page.blogs.edges[0].node.content)"></pre>
          </div>
          <div class="markdown-body" style="padding-top: 20px;">
            <p>
              <img
                :src="'http://119.45.204.135:1337' + $page.blogs.edges[0].node.img.url"
                alt="火狐截图_20180518T170853.526Z.png"
              />
            </p>
          </div>
        </div>
